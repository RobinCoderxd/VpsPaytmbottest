...
var bot_token = '6083753417:AAHs6_b44RvY4w0zeI6ihXXk6_EcyrKDRAM'; //YOUR BOT TOKEN HERE

var bot_name = 'Nodejs Vps Testing'; // Bot Name
...
const admin_id = 1895890424;

const admin_id2 = 5602830736;

var mongo_url = 'mongodb+srv://ROBIN:ROBIN@cluster0.0qezxup.mongodb.net/?retryWrites=true&w=majority'; // Your Mongo URL Here
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        ...
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=1895890424">MR ROBIN ★</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
